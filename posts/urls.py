...
from posts.views import PostViewSet, LikesViewSet, CommentViewSet, Like2ViewSet, AnaliticViewSet


router = DefaultRouter()
router.register('list', PostViewSet)
#router.register('likes', Like2ViewSet)
...
urlpatterns = [
    ...
    #path('likes_list/', LikesViewSet.as_view({'get': 'list'})),
] + router.urls
